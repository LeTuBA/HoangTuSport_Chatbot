...
class Settings(BaseSettings):
    ...
    """
    # App settings
    APP_NAME: str = Field(default="Hoàng Tú Pickleball Shop", validation_alias="APP_NAME")
    ...
    MILVUS_COLLECTION_NAME: str = Field(default="pickleball", validation_alias="MILVUS_COLLECTION_NAME")
